 ...
 */
class TSA_Blog_Adminhtml_Tsa_Blog_Wysiwyg_ImagesController extends Mage_Adminhtml_Controller_Action
{
    /**
     * Init storage
     *
    ...
    public function indexAction()
    {
        ...
        try {
            Mage::helper('tsa_blog/wysiwyg_images')->getCurrentPath();
        } catch (Exception $e) {
    ...
    public function treeJsonAction()
    {
        try {
            ...
            $this->getResponse()->setBody(
                $this->getLayout()->createBlock('tsa_blog/adminhtml_wysiwyg_images_tree')
                    ->getTreeJson()
            );
        } catch (Exception $e) {
    ...
    public function deleteFilesAction()
    {
        try {
            ...
            $helper = Mage::helper('tsa_blog/wysiwyg_images');
            $path = $this->getStorage()->getSession()->getCurrentPath();
    ...
    public function thumbnailAction()
    {
        ...
        $file = Mage::helper('tsa_blog/wysiwyg_images')->idDecode($file);
    ...
    public function getStorage()
    {
        if (!Mage::registry('storage')) {
            $storage = Mage::getModel('tsa_blog/wysiwyg_images_storage');
    ...
    protected function _saveSessionCurrentPath()
    {
        $this->getStorage()
            ->getSession()
            ->setCurrentPath(Mage::helper('tsa_blog/wysiwyg_images')->getCurrentPath());
        return $this;
    }
    ...
    {
        return Mage::getSingleton('admin/session')->isAllowed('tsa_blog/media_gallery');
    }
}
