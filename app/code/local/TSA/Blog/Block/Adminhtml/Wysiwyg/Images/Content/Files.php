 ...
 */
class TSA_Blog_Block_Adminhtml_Wysiwyg_Images_Content_Files extends Mage_Adminhtml_Block_Template
{
    /**
    ...
    public function getFiles()
    {
        if (! $this->_filesCollection) {
            $this->_filesCollection = Mage::getSingleton('tsa_blog/wysiwyg_images_storage')->getFilesCollection(Mage::helper('tsa_blog/wysiwyg_images')->getCurrentPath(), $this->_getMediaType());
    ...
    {
        return Mage::getSingleton('tsa_blog/wysiwyg_images_storage')->getConfigData('resize_width');
    }

    public function getImagesHeight()
    {
        return Mage::getSingleton('tsa_blog/wysiwyg_images_storage')->getConfigData('resize_height');
    }
