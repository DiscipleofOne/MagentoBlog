 ...
 */
class TSA_Blog_Block_Adminhtml_Wysiwyg_Images_Content extends Mage_Adminhtml_Block_Widget_Container
{
    /**
     * Block construction
     */
    ...
    {
        parent::__construct();
        $this->_headerText = $this->helper('tsa_blog')->__('Media Storage');
        $this->_removeButton('back')->_removeButton('edit');
        $this->_addButton('newfolder', array(
            'class'   => 'save',
            'label'   => $this->helper('tsa_blog')->__('Create Folder...'),
            'type'    => 'button',
        ...
        $this->_addButton('delete_folder', array(
            ...
            'label'   => $this->helper('tsa_blog')->__('Delete Folder'),
            'type'    => 'button',
        ...
        $this->_addButton('delete_files', array(
            'class'   => 'delete no-display',
            'label'   => $this->helper('tsa_blog')->__('Delete File'),
            'type'    => 'button',
        ...
        $this->_addButton('insert_files', array(
            ...
            'label'   => $this->helper('tsa_blog')->__('Insert File'),
            'type'    => 'button',
    ...
    public function getFilebrowserSetupObject()
    {
        ...
        $setupObject->setData(array(
            'newFolderPrompt'                 => $this->helper('tsa_blog')->__('New Folder Name:'),
            'deleteFolderConfirmationMessage' => $this->helper('tsa_blog')->__('Are you sure you want to delete current folder?'),
            'deleteFileConfirmationMessage'   => $this->helper('tsa_blog')->__('Are you sure you want to delete the selected file?'),
