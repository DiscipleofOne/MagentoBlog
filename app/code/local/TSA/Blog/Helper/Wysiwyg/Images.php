 ...
 */
class TSA_Blog_Helper_Wysiwyg_Images extends Mage_Core_Helper_Abstract
{
    ...
    public function isUsingStaticUrlsAllowed()
    {
        ...
        Mage::dispatchEvent('tsa_blog_wysiwyg_images_static_urls_allowed', array(
            'result'   => $checkResult,
    ...
    public function getImageHtmlDeclaration($filename, $renderAsTag = false)
    {
        ...
        if ($renderAsTag) {
            ...
            if ($this->isUsingStaticUrlsAllowed()) {
                ...
                $html = Mage::helper('adminhtml')->getUrl('*/tsa_blog_wysiwyg/directive', array('___directive' => $directive));
            }
        }
        return $html;
    }
    ...
    public function getCurrentPath()
    {
        if (!$this->_currentPath) {
            ...
            if (!$io->isWriteable($currentPath) && !$io->mkdir($currentPath)) {
                $message = Mage::helper('tsa_blog')->__('The directory %s is not writable by server.',$currentPath);
    ...
    {
        return Mage::getSingleton('tsa_blog/wysiwyg_images_storage');
    }
